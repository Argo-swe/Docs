...
\usepackage[a4paper]{../../model/geometry}
...
\fancypagestyle{plain}{
	...
	\fancyhf{}
	\lhead{
		\includegraphics[width=1.5cm, keepaspectratio=true]{../../model/logo/PNG/argo_icona.png}
		\parbox[b]{5cm}{
	...
	% \rhead{
	% 	\includegraphics[height=1.25cm, width=1.25cm, keepaspectratio=true]{../../model/PROJECT_LOGO}
	% }

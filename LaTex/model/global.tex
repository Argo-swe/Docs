...
\newcommand{\VersioneST}{3.0.0}
\newcommand{\VersioneMA}{2.0.0}
\newcommand{\VersioneMS}{1.0.0}
\newcommand{\VersioneMUD}{2.0.0}
\newcommand{\VersioneMUF}{2.0.0}
\newcommand{\VersioneDP}{2.0.0}
...
\newcommand{\ManualeUtenteDemo}{\emph{Demo User Manual v\VersioneMUD}}
\newcommand{\ManualeUtenteFramework}{\emph{Framework User Manual v\VersioneMUF}}
...
\newcommand{\stocco}{Tommaso Stocco}
\newcommand{\sebastiano}{Sebastiano Lewental}
\newcommand{\cristo}{Marco Cristo}
...
The aim of this project is to develop a \glossario{framework} aimed at the construction of interactive \glossario{bubbles} to add and improve on the functionalities offered by the communication platform \glossario{Rocket.Chat}.
The project also aims at providing significant examples of such bubbles developed using the aforementioned framework.
}
...
\newcommand{\makeFrontPage}{
  ...
  \begin{center}
  \includegraphics[width=8cm]{../../model/logo/Square/argo_square.png}
  \end{center}
...
%  \vspace{0.2cm}
  ...
  \end{center}
  % \begin{figure}[H]
	% \includegraphics[height=3cm, right]{../../model/PROJECT_LOGO}
  % \end{figure}
  \end{titlepage}

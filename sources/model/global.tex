...
\newcommand{\VersioneNP}{1.0.0}  % Norme di Progetto
\newcommand{\VersioneAR}{1.0.1}  % Analisi dei Requisiti
\newcommand{\VersionePQ}{1.0.0}  % Piano di Qualifica
\newcommand{\VersioneG}{1.0.1}   % Glossario
\newcommand{\VersionePP}{1.0.0}  % Piano di Progetto
\newcommand{\VersioneST}{0.0.5} % Specifica Tecnica
\newcommand{\VersioneMU}{0.0.1} % Manuale Utente

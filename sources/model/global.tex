...
\newcommand{\VersioneNP}{0.0.8}  % Norme di Progetto
\newcommand{\VersionePP}{0.1.0}  % Piano di Progetto
\newcommand{\VersionePQ}{0.0.3}  % Piano di Qualifica
\newcommand{\VersioneAR}{0.0.4}  % Analisi dei Requisiti
\newcommand{\VersioneG}{0.0.3}   % Glossario

...
\newcommand{\VersioneNP}{1.0.3}  % Norme di Progetto
\newcommand{\VersioneG}{1.0.3}   % Glossario
\newcommand{\VersionePQ}{1.1.2}  % Piano di Qualifica
\newcommand{\VersioneAR}{2.0.0}  % Analisi dei Requisiti
\newcommand{\VersioneST}{1.0.0} % Specifica Tecnica
\newcommand{\VersionePP}{1.0.8}  % Piano di Progetto
\newcommand{\VersioneMU}{0.0.7} % Manuale Utente

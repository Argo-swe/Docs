...
\newcommand{\VersioneNP}{0.0.24}  % Norme di Progetto
\newcommand{\VersioneAR}{1.0.1}  % Analisi dei Requisiti
\newcommand{\VersionePQ}{0.2.0}  % Piano di Qualifica
\newcommand{\VersioneG}{1.0.1}   % Glossario
\newcommand{\VersionePP}{0.1.15}  % Piano di Progetto
\newcommand{\VersioneST}{} % Specifica Tecnica

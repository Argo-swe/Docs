...
Si osserva che se i dati sono in eccesso, il modello si confonde, quando invece mancano, genera dati casuali. Il problema è trovare i pezzi minimi per comporre il dizionario dati.

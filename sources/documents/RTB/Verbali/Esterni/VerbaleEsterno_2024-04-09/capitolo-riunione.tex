...
[viene mostrata la bozza]
Sono stati pensati tre attori principali, tra cui un Utente Generico, un Utente Non Autenticato e un Tecnico.
L'utente generico può visualizzare il prompt risultante a seguito dell'inserimento della richiesta in linguaggio naturale e alla selezione del dizionario dati. La visualizzazione della lista dei dizionari dati è sempre possibile per l'utente generico. Quest'ultimo, autenticandosi, può diventare un tecnico.

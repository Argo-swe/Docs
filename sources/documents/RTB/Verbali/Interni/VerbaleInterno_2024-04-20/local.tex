...
\newcommand{\DocDescription}{
	La riunione è stata organizzata con l'obiettivo di analizzare e valutare l'andamento dello \glossario{sprint} appena concluso. Inoltre, il team ha pianificato la prossima iterazione ed esaminato gli \glossario{Issue Tracking System} individuati come possibili alternative all'\glossario{ITS} di \glossario{GitHub}.
}

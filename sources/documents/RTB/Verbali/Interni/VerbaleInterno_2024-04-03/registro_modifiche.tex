	...
	% MAX 12.5cm
 	\begin{longtable}{|P{1cm}|P{2.2cm}|P{2.7cm}|P{2.7cm}|>{\arraybackslash}P{3.8cm}|}
	  \hline
		...
		1.0.0 & 2024-04-05 & \riccardo & \riccardo & Modifica formattazione nella \sezione{sec:versionamento}, Implementazione comandi \glossario{LaTeX}, Approvazione del documento \\

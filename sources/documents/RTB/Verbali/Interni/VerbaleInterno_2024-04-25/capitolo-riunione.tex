...
\begin{itemize}
	\item È stato necessario l'impiego di \glossario{txtai} che richiedeva del materiale per svolgere i test: per questi è stato utilizzato un \glossario{dizionario dati} prelevato da un database di esempio (\glossario{chinook}) di \glossario{SQLite};

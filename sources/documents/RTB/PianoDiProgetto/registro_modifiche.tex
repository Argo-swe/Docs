	...
	% MAX 12.5cm
 	\begin{longtable}{|P{1cm}|P{2.2cm}|P{2.7cm}|P{2.7cm}|>{\arraybackslash}P{3.8cm}|}
	  \hline
		...
		0.0.2 & 2024-04-23 & \raul & \martina,  \mattia & Aggiornamento sezione analisi dei rischi tecnologici e scopo del prodotto \\
		\hline
		0.0.1 & 2024-04-11 & \riccardo & \raul & Strutturazione iniziale del documento \\
	\end{longtable}
\end{adjustwidth}
\egroup

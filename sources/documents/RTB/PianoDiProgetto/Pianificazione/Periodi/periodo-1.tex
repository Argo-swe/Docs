...
\begin{itemize}
  ...
  \item Creazione di una dashboard su \glossario{Google Sheets} per realizzare preventivo e consuntivo dei periodi, rendicontare le ore e generare i grafici in tempo reale;
  ...
  \item Strutturazione iniziale del \glossario{dizionario dati};

...
\begin{itemize}
  ...
  \item Scopo;
  \item Descrizione;
  \item Responsabilità per input, redazione, verifica e approvazione;
  \item Pianificazione per versioni provvisorie e finali.
\end{itemize}

\paragraph{Progettazione e sviluppo}
Questa attività consiste nel progettare e redarre ciascun documento nel rispetto degli standard definiti per formato e contenuto, controllati dal \glossario{Verificatore}.
...
\begin{enumerate}
  \item Vengono definite le caratteristiche di base del documento o di una sua parte come da \ref{implementazioneprocessodocumentazione};
  ...
  \item In seguito a un esito positivo della verifica, se il risultato è un documento completo e che richiede rilascio, viene sottoposto a una approvazione finale del responsabile, bloccante in modo analogo alla verifica.
\end{enumerate}
...
\begin{itemize}
  \item \textbf{Termini nel Glossario:} Indicati alla prima occorrenza di un documento in \textit{corsivo} e con una \textit{\small{G}} a fine parola;

...
\newcommand{\DocDescription}{
	Il gruppo ha organizzato un incontro con la \glossario{Proponente} per esporre il lavoro svolto nelle ultime settimane e presentare il progetto finale che verrà portato alla revisione \glossario{PB}.
}

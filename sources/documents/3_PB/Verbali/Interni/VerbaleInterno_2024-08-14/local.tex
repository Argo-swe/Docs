...
\newcommand{\DocDescription}{
	Durante l'incontro, il gruppo ha assegnato le attività di testing. Inoltre, è stato esaminato il diagramma delle classi redatto dai progettisti. Infine, il team ha risolto alcuni errori emersi durante la scrittura dei test \glossario{front-end}.
}

...
Tutte le istruzioni fornite sono riferite all'utilizzo dell'applicativo con il tema chiaro e con il sistema impostato in lingua italiana. Se si ha la necessità di cambiarlo, si veda la sezione 5 (Impostazioni generali).
...
È possibile che si verifichino degli errori e il sistema non sia in grado di formulare il prompt data la richiesta. In questo caso è consigliabile controllare il dizionario dati scelto (sezione 6.2.2 - Accesso ad informazioni aggiuntive sul dizionario dati scelto) o se l'interrogazione utilizza i termini corretti e coerenti.

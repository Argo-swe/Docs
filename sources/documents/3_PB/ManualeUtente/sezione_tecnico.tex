...
\subsection*{Avviso}
Per accedere a tutte le funzionaità del Tecnico sarà necessario effettuare il login con successo.
...
\begin{figure}[H]
  ...
  \caption{Schermata di gestione \glossario{dizionari dati}}
\end{figure}
\par La schermata mostra la lista completa dei \glossario{dizionari dati} caricati nel sistema. Vengono fornite le funzionalità per operare su di essi.
...
\begin{figure}[H]
  ...
  \caption{Modale di creazione \glossario{dizionario dati}}
\end{figure}
\begin{itemize}
...
\subsubsection{Scarica file \glossario{dizionario dati}}
...
\subsubsection{Elimina file \glossario{dizionario dati}}
...
\begin{figure}[H]
  ...
  \caption{Modale di conferma eliminazione \glossario{dizionario dati}}
\end{figure}

...
\par Nell'undicesimo \glossario{sprint}, il valore misurato si è allontanato dalla soglia desiderata a causa del tempo richiesto per la configurazione dei test. Nel corso dello sprint, infatti, la maggior parte delle attività di testing \glossario{back-end} sono state posticipate. A partire dal dodicesimo sprint, la differenza tra i task pianificati e quelli completati si è nuovamente avvicinata al valore ambito.

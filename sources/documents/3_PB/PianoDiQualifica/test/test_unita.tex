...
\begin{adjustwidth}{-0.5cm}{-0.5cm}
	...
	\hline TU & Verificare che il metodo "delete_dictionary" della classe "SqlAlchemyDictionaryRepositoryAdapter" soddisfi le seguenti condizioni:
	\begin{itemize}
	...
	\hline TU & Verificare che il metodo "get_all_dictionaries" della classe "SqlAlchemyDictionaryRepositoryAdapter" soddisfi le seguenti condizioni:
	\begin{itemize}
	...
	\hline TU & Verificare che il metodo "get_dictionary_by_id" della classe "SqlAlchemyDictionaryRepositoryAdapter" soddisfi le seguenti condizioni:
	\begin{itemize}
	...
	\hline TU & Verificare che il metodo "get_dictionary_by_name" della classe "SqlAlchemyDictionaryRepositoryAdapter" soddisfi le seguenti condizioni:
	\begin{itemize}
	...
	\begin{itemize}
		...
		\item Deve sollevare un'eccezione "ValueError" se la configurazione manca della chiave "db_manager", con un messaggio di errore che indichi l'assenza di tale chiave.
	\end{itemize} & S \\
	...
	\end{itemize} & S \\
		...
		\hline TU & Verificare che il metodo "__get_tuples" della classe "TxtaiPromptManagerAdapter" soddisfi le seguenti condizioni:
	\begin{itemize}
	...
	\end{itemize} & S \\
		...
		\hline TU & Verificare che il metodo "__get_relevant_tuples" della classe "TxtaiPromptManagerAdapter" soddisfi le seguenti condizioni:
	\begin{itemize}
	...
	%txtai_index_manager_adapter
		\hline TU & Verificare che il metodo "get_embeddings" della classe "TxtaiIndexManagerAdapter" soddisfi le seguenti condizioni:
	\begin{itemize}
		\item Deve restituire un'istanza della classe "Embeddings".
	\end{itemize} & S \\

		\hline TU & Verificare che il metodo "create_or_load_index" della classe "TxtaiIndexManagerAdapter" soddisfi le seguenti condizioni:
	\begin{itemize}
	...
	\end{itemize} & S \\
		...
		\hline TU & Verificare che il metodo "create_index" della classe "TxtaiIndexManagerAdapter" soddisfi le seguenti condizioni:
	\begin{itemize}
		\item Deve creare un indice utilizzando i documenti estratti e salvarlo correttamente se "save_index" è impostato a "True";
		\item Deve creare un indice senza salvarlo se "save_index" è impostato a "False";
		\item Deve creare un indice anche se la lista dei documenti è vuota e comunque salvare l'indice se "save_index" è impostato a "True";
		\item Deve sollevare un'eccezione se si verifica un errore durante l'indicizzazione e non deve salvare l'indice.
	\end{itemize} & S \\

		\hline TU & Verificare che il metodo "save_index" della classe "TxtaiIndexManagerAdapter" soddisfi le seguenti condizioni:
	\begin{itemize}
	...
	\end{itemize} & S \\
		...
		\hline TU & Verificare che il metodo "load_index" della classe "TxtaiIndexManagerAdapter" soddisfi le seguenti condizioni:
	\begin{itemize}
		\item Deve caricare correttamente l'indice utilizzando il percorso del file corretto.
	\end{itemize} & S \\

		\hline TU & Verificare che il metodo "delete_index" della classe "TxtaiIndexManagerAdapter" soddisfi le seguenti condizioni:
	\begin{itemize}
	...
	%txtai_embeddings_manager_factory
		\hline TU & Verificare che il metodo "create_index_manager" della classe "TxtaiEmbeddingsManagerFactory" soddisfi le seguenti condizioni:
	\begin{itemize}
	...
	\end{itemize} & S \\
		...
		\hline TU & Verificare che il metodo "create_prompt_manager_with_dependencies" della classe "TxtaiEmbeddingsManagerFactory" soddisfi le seguenti condizioni:
	\begin{itemize}
	...
	\end{itemize} & S \\
		...
		\hline TU & Verificare che il metodo "create_prompt_manager" della classe "TxtaiEmbeddingsManagerFactory" soddisfi le seguenti condizioni:
	\begin{itemize}
	...
	\end{itemize} & S \\
		...
		\hline TU & Verificare che il metodo "semantic_search_log" della classe "TxtaiDebugManagerAdapter" soddisfi le seguenti condizioni:
	\begin{itemize}

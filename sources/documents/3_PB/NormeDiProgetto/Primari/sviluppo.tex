...
Il \glossario{processo} di sviluppo contiene le seguenti attività e compiti dello \glossario{sviluppatore}:
\begin{itemize}
...
\begin{itemize}
  ...
  \item Se si realizza un'estensione tra casi d'uso, questa viene esplicitata attraverso un \glossario{extension point}, il quale spiega le condizioni che portano allo scenario alternativo.
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Architettura generale}: descrizione dell'architettura del sistema e della struttura del \glossario{repository};
...
\paragraph*{Linee guida progettazione dei componenti back-end}
\begin{itemize}
  \item \textbf{Descrizione}: breve descrizione delle funzionalità del componente;
...
\paragraph*{Linee guida progettazione di dettaglio back-end}
\begin{itemize}
...
\par La documentazione del codice sorgente deve essere conforme alle linee guida di Google relative alla scrittura di \glossario{docstring} in Python (\href{https://google.github.io/styleguide/pyguide.html}{https://google.github.io/styleguide/pyguide.html} (Ultimo accesso: 2024-09-20)). In particolare:
\begin{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Nomi delle classi}: \glossario{PascalCase};
...
\paragraph*{Convenzioni sintattiche}
\begin{itemize}
  \item \textbf{Nomi dei file}: \glossario{PascalCase};
...
\paragraph*{Documentazione del codice}
\vspace{0.5\baselineskip}
\par La documentazione del codice sorgente deve essere conforme al formato \glossario{JSDoc} (\href{https://jsdoc.app}{https://jsdoc.app} (Ultimo accesso: 2024-09-20)), compatibile sia con JavaScript che con TypeScript.
...
\par Il team aderisce alle regole di formattazione e stile per CSS definite al seguente indirizzo: \href{https://google.github.io/styleguide/htmlcssguide.html}{https://google.github.io/styleguide/htmlcssguide.html} (Ultimo accesso: 2024-09-20). Il codice CSS è organizzato in tre sezioni:
\begin{itemize}
...
\par Il team aderisce alle regole di formattazione e stile per HTML definite al seguente indirizzo: \href{https://google.github.io/styleguide/htmlcssguide.html}{https://google.github.io/styleguide/htmlcssguide.html} (Ultimo accesso: 2024-09-20).
...
\subsubsubsection{Linee guida test}
\begin{itemize}

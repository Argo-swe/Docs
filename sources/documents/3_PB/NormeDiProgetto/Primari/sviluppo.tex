...
\par La documentazione del codice sorgente deve essere conforme alle linee guida di Google relative alla scrittura di \glossario{docstring} in Python (\href{https://google.github.io/styleguide/pyguide.html}{https://google.github.io/styleguide/pyguide.html} (Ultimo accesso: 2024-09-05)). In particolare:
\begin{itemize}
...
\paragraph*{Documentazione del codice}
\vspace{0.5\baselineskip}
\par La documentazione del codice sorgente deve essere conforme al formato \glossario{JSDoc} (\href{https://jsdoc.app}{https://jsdoc.app} (Ultimo accesso: 2024-09-05)), compatibile sia con JavaScript che con TypeScript.

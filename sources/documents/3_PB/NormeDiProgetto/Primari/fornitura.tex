...
\begin{enumerate}
  ...
  \item \textbf{Architettura}: descrive l'architettura del software, specificando i modelli architetturali, la struttura del \glossario{repository} e il deployment del prodotto;

...
\begin{adjustwidth}{-0.5cm}{-0.5cm}
  ...
  \begin{longtable}{|P{3cm}|P{6,5cm}|>{\arraybackslash}P{4cm}|}
    ...
    \hline
    \textbf{RF.OP.10.5} & L'Utente deve poter visualizzare la data di ultimo aggiornamento di un dizionario dati. & \hyperref[UC10point5]{UC10.5}\\
    \hline
    ...
    \hline
    \textbf{RF.D.24} & Il Tecnico deve visualizzare un errore nel caso in cui il download del file non vada a buon fine. &  \hyperref[UC24]{UC24}\\
    \hline
    ...
    \hline
    \textbf{RF.OP.36} & L'Utente deve poter effettuare una ricerca per nome tra i \glossario{dizionari dati} caricati nel sistema. & \hyperref[UC36]{UC36}, Verbale interno \\
    \hline
    \textbf{RF.OP.37} & L'Utente deve poter effettuare una ricerca per descrizione tra i dizionari dati caricati nel sistema. & \hyperref[UC37]{UC37}, Verbale interno \\
    \hline
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    Funzionale & 62 & 7 & 12 & 81 \\
    \hline
    Di qualità & 5 & 2 & 0 & 7 \\
    \hline 
    Di vincolo & 13 & 3 & 0 & 16 \\
    \hline
    \textbf{Totale} & 80 & 12 & 12 & \textbf{104} \\ 
    \hline
  \end{tabular}

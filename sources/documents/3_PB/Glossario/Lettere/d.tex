...
\par Vedi \glossario{Docker}.

\vspace{2em}
\subsection*{Docstring}
\par Una docstring è una stringa di documentazione utilizzata nei linguaggi di programmazione, come \glossario{Python}, per descrivere il comportamento e l'uso di funzioni, classi o moduli, in modo simile ai commenti. Le docstring sono facilmente accessibili e visualizzabili dagli strumenti di documentazione automatica.

...
\par SonarLint è un plugin per ambienti di sviluppo come Visual Studio Code che fornisce funzionalità avanzate di \glossario{linting}, aiutando gli sviluppatori a rilevare e correggere problemi nel codice in tempo reale.

...
\par camelCase è una convenzione di denominazione in cui la prima lettera della prima parola è scritta in minuscolo, mentre la prima lettera di ogni parola successiva è scritta in maiuscolo.

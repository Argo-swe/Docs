...
\begin{itemize}
    ...
    \begin{itemize}
        \item \texttt{SqlAlchemyDbManagerFactory}: utilizzata per astrarre la creazione dei diversi tipi di database manager;
        \item \texttt{TxtaiEmbeddingsManagerFactory}: gestisce la creazione degli embeddings manager, con supporto per diversi algoritmi di embeddings.
    \end{itemize}
\end{itemize}

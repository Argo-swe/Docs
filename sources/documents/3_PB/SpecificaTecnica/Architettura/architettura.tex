...
\input{Architettura/Frontend/struttura}
\input{Architettura/Backend/struttura}

\subsection{Progettazione dei componenti}
\input{Architettura/Frontend/progettazione_logica}
\input{Architettura/Backend/progettazione_logica}
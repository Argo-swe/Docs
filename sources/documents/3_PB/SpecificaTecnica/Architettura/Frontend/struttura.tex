...
\begin{itemize}
  ...
  \item \textbf{views}: contiene le viste dell'applicazione. Una vista è un componente principale che può essere suddiviso in sottocomponenti, disponibili nella cartella "components". In genere, le view rappresentano pagine o sezioni centrali e sono gestite dal router di Vue.
\end{itemize}
...
\begin{adjustwidth}{-0.5cm}{-0.5cm}
	% MAX 12.5cm
 	\begin{longtable}{|P{2.2cm}|P{2.2cm}|>{\raggedright\arraybackslash}P{8.1cm}|}
...
\begin{adjustwidth}{-0.5cm}{-0.5cm}
    ...
    \hline Pydantic & 2.8.2 & Libreria per la validazione dei dati mediante le annotazioni di tipo di Python \\
    \hline PrimeVue & 3.53.0 & Libreria di componenti per Vue.js \\
    \hline Vuex (Pinia) & 3.10.12 & Libreria di gestione dello stato tra i componenti per applicazioni Vue.js \\

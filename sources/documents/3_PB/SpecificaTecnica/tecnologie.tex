...
\par pytest è un \glossario{framework} di test Python che può essere utilizzato per scrivere test di unità, test di integrazione e test end-to-end.
\paragraph*{Motivazioni}
\begin{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Completezza}: Jest è una soluzione completa che include un test runner, una libreria di asserzioni e il mocking integrato. Ciò riduce la necessità di installare e configurare più librerie;
  ...
  \item \textbf{Mocking}: Jest ha integrate capacità di mocking potenti e facili da usare permettendo agli sviluppatori di mockare funzioni, moduli e timer senza librerie aggiuntive;
  \item \textbf{Accuratezza degli output}: Jest offre messaggi di errore chiari e informativi, facilitando l'identificazione e la risoluzione dei problemi. La modalità watch integrata aiuta anche nel debug rapido dei test durante lo sviluppo;

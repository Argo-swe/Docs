...
\begin{samepage}
  ...
  \begin{tikzpicture}[overlay]
      ...
      \node [anchor = south east] at (\textwidth-1cm,-0.2cm) {\includegraphics[width=5.5cm]{\ModelAssets{signatures/firma_tommaso.png}}}; % Dimensioni e coordinate da variare in base a ciascuna firma

...
\par Il documento di \AdR\ è accessibile direttamente tramite il seguente \href{https://argo-swe.github.io/2_RTB/AnalisiDeiRequisiti.pdf}{collegamento}. \newline

\par Il codice sorgente del Proof of Concept (PoC) è disponibile al seguente indirizzo: \newline

\quad \href{https://github.com/Argo-swe/ChatSQL/tree/v1.0.0}{https://github.com/Argo-swe/ChatSQL/tree/v1.0.0} \newline

...
\par Il meeting è iniziato con una richiesta sulle mansioni del progettista per il prossimo \glossario{sprint}. 
...
\par La proposta è stata quindi quella di usare come stumento proprio \glossario{Streamlit}\ per sviluppare le feature richieste per il Proof of Concept, in modo da capirne la fattibilità dell'implementazione. 

	...
	% MAX 12.5cm
 	\begin{longtable}{|P{1cm}|P{2.2cm}|P{2.7cm}|P{2.7cm}|>{\arraybackslash}P{3.8cm}|}
	  \hline
		...
		1.0.0 & 2024-05-21 & \tommaso & \tommaso & Approvazione del documento \\
		\hline
		0.0.2 & 2024-05-10 & \raul & \tommaso, \sebastiano, \marco & Inserimento codici delle attività \\
		\hline
		0.0.1 & 2024-05-07 & \raul & \tommaso, \sebastiano, \marco & Stesura del documento \\
	\end{longtable}
\end{adjustwidth}
\egroup
...
\begin{itemize}
	\item Il gruppo ha discusso le modalità di implementazione della funzionalità di debug. In particolare, si è deciso di gestire il \glossario{log} come un file separato che il \glossario{Tecnico} può scaricare. Nell'interfaccia grafica, invece, la visualizzazione sarà strutturata con dati tabulari;

...
\newcommand{\DocDescription}{
	Durante l'incontro sono state esaminate le metriche emerse durante gli \glossario{sprint} precedenti e si sono decisi dei valori tollerabili e desiderabili per quest'ultime.

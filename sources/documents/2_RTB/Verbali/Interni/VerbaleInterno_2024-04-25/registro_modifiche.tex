	...
	% MAX 12.5cm
 	\begin{longtable}{|P{1cm}|P{2.2cm}|P{2.7cm}|P{2.7cm}|>{\arraybackslash}P{3.8cm}|}
	  \hline
		...
		\hline
		0.0.2 & 2024-04-27 & \raul, \riccardo & \martina, \mattia & Correzioni generali, aggiornamento della \sezione{sec:programmatore} \\
		\hline
		0.0.1 & 2024-04-26 & \raul & \martina, \mattia & Stesura del documento \\
	\end{longtable}
\end{adjustwidth}
\egroup
...
\textbf{Domanda:} L'analista illustra i \glossario{casi d'uso} relativi alla funzionalità di \glossario{debug} disponibile per il profilo Tecnico. Il report ideato dal team comprende una lista di tabelle con annesso il punteggio di rilevanza. 

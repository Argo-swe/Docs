...
\newcommand{\DocDescription}{
	Il gruppo ha organizzato un incontro con la Proponente per esporre il lavoro svolto nelle ultime settimane e presentare la versione del Proof of Concept che verrà portata alla \RTB.
}

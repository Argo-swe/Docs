...
\begin{longtable}{|P{3cm}|P{6,5cm}|>{\arraybackslash}P{4cm}|}
  ...
  \hline
  \textbf{RQ.O.7} & Il sistema deve avere un'alta recall, ovvero il prompt generato deve contenere le tabelle necessarie per costruire correttamente la query SQL. & Verbale Esterno 2024-05-22 \\
  \hline
...
\begin{longtable}{|P{3cm}|P{6,5cm}|>{\arraybackslash}P{4cm}|}
  ...
  \hline
  \textbf{RV.O.6} & Il file impiegato come dizionario dati può essere anche un \glossario{dump SQL} (esportabile direttamente da una base di dati). & Verbale Interno \\
  \hline

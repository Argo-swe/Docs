...
\begin{longtable}{|P{3cm}|P{6,5cm}|>{\arraybackslash}P{4cm}|}
    ...
    \hline
    \textbf{RF.D.27} & Il sistema deve memorizzare gli embeddings generati durante il caricamento o la modifica del dizionario dati. & Verbale Esterno 2024-05-06 \\
    \hline
...
\begin{longtable}{|P{3cm}|P{6,5cm}|>{\arraybackslash}P{4cm}|}
  ...
  \hline
  \textbf{RQ.OP.7} & Deve essere definita una batteria di test per valutare la ricerca semantica. Lo scopo dei test è verificare che tutte le tabelle necessarie siano presenti nel prompt. & Verbale Esterno 2024-05-22 \\
  \hline
  \textbf{RQ.OP.8} & Deve essere definita una batteria di test per valutare l'accuratezza del prompt generato. Lo scopo dei test è verificare che mantenendo lo stesso prompt e chiedendo a un modello di riscrivere la frase dell'utente per un certo numero di volte, la query SQL rimanga invariata. & Verbale Esterno 2024-06-07 \\
  \hline
...
\begin{longtable}{|P{3cm}|P{6,5cm}|>{\arraybackslash}P{4cm}|}
  ...
  \hline
  \textbf{RV.O.4} & Il \glossario{dizionario dati} in formato JSON deve rispecchiare la struttura e il contenuto di un database. & Capitolato \\
  \hline
  ...
  \hline
  \textbf{RV.O.9} & Il \glossario{back-end} dell'applicazione deve importare la libreria \glossario{Flask} versione 3.0.0 o successive. & Verbale Interno \\
  \hline
  \textbf{RV.O.10} & Il \glossario{back-end} dell'applicazione deve importare la libreria \glossario{Flask-CORS} versione 4.0.0 o successive. & Verbale Interno \\
  \hline
  \textbf{RV.O.11} & Il \glossario{back-end} dell'applicazione deve importare la libreria \glossario{txtai} versione 7.0.0 o successive. & Verbale Interno \\
  \hline
  \textbf{RV.O.12} & Il \glossario{back-end} dell'applicazione deve utilizzare modelli di \glossario{sentence similarity} per la generazione degli \glossario{embeddings}. & Verbale Esterno 2024-05-06 \\
  \hline
  \textbf{RV.O.13} & Gli \glossario{embeddings} devono essere salvati in un database di vettori. & Verbale Esterno 2024-05-06 \\
  \hline
  \textbf{RV.O.14} & Il \glossario{front-end} dell'applicazione deve essere implementato utilizzando \glossario{Node.js} versione 20.14.0. & Verbale Interno \\
  \hline
  \textbf{RV.O.15} & Il \glossario{front-end} dell'applicazione deve essere implementato utilizzando \glossario{Vue.js} versione 3.4.21. & Verbale Interno \\
  \hline
  ...
  \hline
  \textbf{RV.O.18} & L'applicazione deve essere compatibile con il \glossario{browser} Google Chrome versione 110 e successive. & Verbale Interno \\
  \hline
  \textbf{RV.O.19} & L'applicazione deve essere compatibile con il \glossario{browser} Mozilla Firefox versione 109 e successive. & Verbale Interno \\
  \hline
  \textbf{RV.O.20} & L'applicazione deve essere compatibile con il \glossario{browser} Safari versione 15 e successive. & Verbale Interno \\
  \hline
  \textbf{RV.O.21} & L'applicazione deve essere compatibile con il \glossario{browser} Opera versione 94 e successive. & Verbale Interno \\
  \hline
  \textbf{RV.O.22} & L'applicazione deve essere compatibile con il \glossario{browser} Microsoft Edge versione 110 e successive. & Verbale Interno \\
  \hline
  \textbf{RV.OP.23} & L'applicazione deve essere sviluppata, testata e distribuita mediante \glossario{Docker}. & Verbale Interno \\
  \hline

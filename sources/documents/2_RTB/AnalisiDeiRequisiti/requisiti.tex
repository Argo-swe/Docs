...
\begin{longtable}{|P{3cm}|P{6,5cm}|>{\arraybackslash}P{4cm}|}
  ...
  \hline
  \textbf{RQ.D.7} & Verificare la correttezza della ricerca semantica, ovvero l'estrazione dal dizionario dati di tutte le tabelle necessarie. & Verbale Esterno 2024-05-22 \\
  \hline
  \textbf{RQ.OP.8} & Verificare l'accuratezza del prompt generato. & Verbale Esterno 2024-06-07 \\
  \hline
  \textbf{RQ.OP.9} & Verificare la correttezza delle query SQL fornite dal sistema di AI. Avendo a disposizione un database, oltre ai metadati, è possibile controllare quante query SQL fornite da un \glossario{LLM} risultano efficaci. & Capitolato \\
  \hline
...
\begin{longtable}{|P{3cm}|P{6,5cm}|>{\arraybackslash}P{4cm}|}
  ...
  \hline
  \textbf{RV.O.8} & Il back-end dell'applicazione deve importare la libreria \glossario{Flask} versione 3.0.0 o successive. & Verbale Interno \\
  \hline
  \textbf{RV.O.9} & Il back-end dell'applicazione deve importare la libreria \glossario{Flask-CORS} versione 4.0.0 o successive. & Verbale Interno \\
  \hline
  \textbf{RV.O.10} & Il back-end dell'applicazione deve importare la libreria \glossario{txtai} versione 7.0.0 o successive. & Verbale Interno \\
  \hline
  \textbf{RV.O.11} & Il back-end dell'applicazione deve utilizzare modelli di \glossario{sentence similarity} per la generazione degli \glossario{embeddings}. & Verbale Esterno 2024-05-06 \\
  \hline
  \textbf{RV.O.12} & Gli embeddings devono essere salvati in un database di vettori. & Verbale Esterno 2024-05-06 \\
  \hline
  \textbf{RV.O.13} & Il \glossario{front-end} dell'applicazione deve essere implementato utilizzando \glossario{Node.js} versione 20.14.0. & Verbale Interno \\
  \hline
  \textbf{RV.O.14} & Il front-end dell'applicazione deve essere implementato utilizzando \glossario{Vue.js} versione 3.4.21. & Verbale Interno \\
  \hline
  \textbf{RV.O.15} & L'applicazione deve essere accessibile e fruibile da dispositivi mobili con sistema operativo Android versione 13 e successive. & Verbale Interno \\
  \hline
  \textbf{RV.O.16} & L'applicazione deve essere accessibile e fruibile da dispositivi mobili con sistema operativo iOS versione 17 e successive. & Verbale Interno \\
  \hline
  \textbf{RV.O.17} & L'applicazione deve essere compatibile con il browser Google Chrome versione 110 e successive. & Verbale Interno \\
  \hline
  \textbf{RV.O.18} & L'applicazione deve essere compatibile con il browser Mozilla Firefox versione 109 e successive. & Verbale Interno \\
  \hline
  \textbf{RV.O.19} & L'applicazione deve essere compatibile con il browser Safari versione 15 e successive. & Verbale Interno \\
  \hline
  \textbf{RV.O.20} & L'applicazione deve essere compatibile con il browser Opera versione 94 e successive. & Verbale Interno \\
  \hline
  \textbf{RV.O.21} & L'applicazione deve essere compatibile con il browser Microsoft Edge versione 110 e successive. & Verbale Interno \\
  \hline
  \textbf{RV.OP.22} & L'applicazione deve essere sviluppata, testata e distribuita mediante \glossario{Docker}. & Verbale Interno \\
  \hline

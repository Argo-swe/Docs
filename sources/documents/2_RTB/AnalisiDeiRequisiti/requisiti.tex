...
\begin{longtable}{|P{3cm}|P{6,5cm}|>{\arraybackslash}P{4cm}|}
  ...
  \hline
  \textbf{RV.O.8} & Il \glossario{back-end} dell'applicazione deve essere implementato utilizzando il linguaggio \glossario{Python} versione 3.10.12. & Verbale Interno \\
  \hline
  \textbf{RV.O.9} & Il back-end dell'applicazione deve importare la libreria \glossario{Flask} versione 3.0.0 o successive. & Verbale Interno \\
  \hline
  \textbf{RV.O.10} & Il back-end dell'applicazione deve importare la libreria \glossario{Flask-CORS} versione 4.0.0 o successive. & Verbale Interno \\
  \hline
  \textbf{RV.O.11} & Il back-end dell'applicazione deve importare la libreria \glossario{txtai} versione 7.0.0 o successive. & Verbale Interno \\
  \hline
  \textbf{RV.O.12} & Il back-end dell'applicazione deve utilizzare modelli di \glossario{sentence similarity} per la generazione degli \glossario{embeddings}. & Verbale Esterno 2024-05-06 \\
  \hline
  ...
  \hline
  \textbf{RV.O.15} & Il front-end dell'applicazione deve essere implementato utilizzando \glossario{Vue.js} versione 3.4.21. & Verbale Interno \\
  \hline

...
\begin{longtable}{|P{4,5cm}|>{\arraybackslash}P{9cm}|}
  ...
  \hline
  % capitolato
  \emph{Capitolato} & RF.O.3, RF.O.4, RF.O.5, RF.O.8, RF.O.16, RV.O.37, RF.OP.40, RV.O.41, RF.OP.42, RF.D.52, RQ.D.3, RQ.D.4, RQ.O.5, RQ.O.6, RQ.OP.10 \\
  \hline
  % documenti
  \NdP{} & RQ.O.1, RQ.O.2 \\
  \hline
  % verbali
  \emph{Verbali Esterni} & RF.O.1, RF.O.14, RF.D.38, RF.O.43, RF.O.44, RF.O.46, RF.O.48, RF.O.49, RF.O.50, RF.O.51, RF.O.53 \\
  \hline
  \emph{Verbali Interni} & RF.O.1, RF.O.1.1, RF.O.1.2, RF.D.39, RF.D.45, RF.OP.47, \\
  \hline
  % casi d'uso

...
\begin{longtable}{|P{3cm}|P{6,5cm}|>{\arraybackslash}P{4cm}|}
    ...
    \hline
    %\textbf{R.FOP19} & Il Tecnico deve poter incollare la \glossario{query} SQL. &  \hyperref[UC19]{UC19}\\ versione vecchia di un caso che non si sa se sia UC o test di unità

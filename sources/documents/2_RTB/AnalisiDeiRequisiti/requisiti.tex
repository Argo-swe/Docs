...
\begin{longtable}{|P{3cm}|P{6,5cm}|>{\arraybackslash}P{4cm}|}
    ...
    \hline
    \textbf{R.FO1} & L’Utente Non Autenticato deve poter effettuare la procedura di login. &  \hyperref[UC1]{UC1}, \emph{Verbale Esterno 2024-04-09}, \emph{Verbale Interno 2024-04-20}\\
    \hline
    \textbf{R.FO1.1} & L’Utente Non Autenticato deve poter inserire la propria e-mail per autenticarsi. & \hyperref[UC1point1]{UC1.1}, \emph{Verbale Interno 2024-04-20}\\
    \hline
    \textbf{R.FO1.2} & L’Utente Non Autenticato deve poter inserire la propria password per autenticarsi. & \hyperref[UC1point2]{UC1.2}, \emph{Verbale Interno 2024-04-20}\\
    \hline
    \textbf{R.FO2} & L'Utente Non Autenticato riceve un messaggio d'errore in caso di login errato. &  \hyperref[UC2]{UC2}\\
    \hline
    \textbf{R.FO2.1} & L'Utente Non Autenticato riceve un messaggio d'errore in caso di incompleto inserimento delle credenziali. & \hyperref[UC2point1]{UC2.1}\\
    \hline
    \textbf{R.FO2.2} & L’Utente Non Autenticato riceve un messaggio d'errore in caso di credenziali errate. & \hyperref[UC2point2]{UC2.2}\\
    \hline
    \textbf{R.FO2.3} & L’Utente Non Autenticato riceve un messaggio d'errore in caso non vega trovato un utente registrato corrispondente. & \hyperref[UC2point3]{UC2.3}\\
    \hline
    \textbf{R.FO3} & L’Utente Non Autenticato deve poter inserire una richiesta in linguaggio naturale. &  \hyperref[UC3]{UC3}, \emph{Capitolato}\\
    \hline
    \textbf{R.FO4} & L’Utente Autenticato deve poter selezionare il \glossario{dizionario dati}. &  \hyperref[UC4]{UC4}, \emph{Capitolato}\\
    \hline
    \textbf{R.FO5} & L'applicazione deve generare il prompt come output. &  \hyperref[UC5]{UC5}, \emph{Capitolato}\\
    \hline
    \textbf{R.FO6} & L’Utente Autenticato riceve un messaggio d'errore in caso di errore durante la generazione del prompt. &  \hyperref[UC6]{UC6}\\
    \hline
    \textbf{R.FD7} & L’Utente Autenticato deve poter scegliere la lingua in cui inserire la richiesta in linguaggio naturale. &  \hyperref[UC7]{UC7}\\
    \hline
    \textbf{R.FO8} & L’Utente Autenticato deve poter copiare il prompt generato. &  \hyperref[UC8]{UC8}, \emph{Capitolato}\\
    \hline
    \textbf{R.FO9} & L’Utente Autenticato deve poter visualizzare il dettaglio dei \glossario{dizionario dati} caricati. &  \hyperref[UC9]{UC9}\\
    \hline
    \textbf{R.FO9.1} & L’Utente Autenticato deve poter visualizzare il nome del \glossario{dizionario dati} selezionato. &  \hyperref[UC9point1]{UC9.1}\\
    \hline
    \textbf{R.FO9.2} & L’Utente Autenticato deve poter visualizzare la descrizione del \glossario{dizionario dati} selezionato. &  \hyperref[UC9point2]{UC9.2}\\
    \hline
    \textbf{R.FO10} & L’Utente Autenticato deve poter visualizzare la lista dei dizionari dati. &  \hyperref[UC10]{UC10}\\
    \hline
    \textbf{R.FO11} & L’Utente Autenticato riceve un messaggio d'errore in caso di errore durante il caricamento del dettaglio del\glossario{dizionario dati}. &  \hyperref[UC11]{UC11}\\
    \hline
    \textbf{R.FO12} & L’Utente Autenticato deve poter effettuare il logout. &  \hyperref[UC12]{UC12}\\
    \hline

...
\begin{longtable}{|P{3cm}|P{6,5cm}|>{\arraybackslash}P{4cm}|}
  ...
  \hline
  \textbf{RV.O.6} & La dimensione del file JSON utilizzato come \glossario{dizionario dati} deve essere inferiore a 1MB & Verbale Interno \\
  \hline

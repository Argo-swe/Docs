...
\begin{itemize}
  \item Il \glossario{dizionario dati} è stato selezionato in modo corretto ed è ora attivo nel sistema.
\end{itemize}

\paragraph*{Trigger}
L'Utente vuole selezionare il \glossario{dizionario dati} da utilizzare nell'applicazione.

...
\begin{itemize}
  \item L'applicazione opera la generazione del \glossario{prompt} considerando la lingua selezionata.
\end{itemize}
...
\begin{enumerate}
  \item L’Utente seleziona una lingua da una lista predefinita di lingue. La scelta è tra:
    \begin{itemize}
      ...
      \item Tedesco.
    \end{itemize}
  \item L’Utente inserisce una interrogazione in linguaggio naturale nella lingua selezionata nell’ apposito box su cui poi il sistema potrà produrre un \glossario{prompt} in seguito. 
\end{enumerate}

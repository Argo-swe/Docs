...
\begin{itemize}
  \item Modifica titolo \glossario{dizionario dati} (\hyperref[UC16point1]{UC16.1}); %Manca caso errore
  \item Modifica descrizione \glossario{dizionario dati} (\hyperref[UC16point2]{UC16.2}); %Manca caso errore
  \item Modifica file configurazione \glossario{dizionario dati} (\hyperref[UC16point3]{UC16.3}); %Manca caso errore
\end{itemize}

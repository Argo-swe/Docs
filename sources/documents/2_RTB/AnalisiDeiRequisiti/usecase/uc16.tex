...
\begin{itemize}
  ...
  \item Visualizzazione errore per modifica incorretta del \glossario{dizionario dati} (\hyperref[UC20]{UC20})
\end{itemize}
...
\paragraph{Estensione}
\begin{itemize}
  \item Visualizzazione errore per modifica incorretta del titolo del \glossario{dizionario dati} (\hyperref[UC20point1]{UC20.1}).
\end{itemize}
...
\paragraph{Estensione}
\begin{itemize}
  \item Visualizzazione errore per modifica incorretta della descrizione del \glossario{dizionario dati} (\hyperref[UC20point2]{UC20.2}).
\end{itemize}
...
\paragraph*{Estensione}
\begin{itemize}
  \item Visualizzazione errore per mancato caricamento del \glossario{dizionario dati} (\hyperref[UC19]{UC19}).
\end{itemize}
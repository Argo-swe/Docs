...
Il Tecnico interroga il sistema per verificare l'interazione tra il \glossario{dizionario dati} e il modello di AI. Visualizza quindi un file di log contenente il processo di generazione del \glossario{prompt}.

...
\begin{enumerate}
  \item Il Tecnico inserisce il file, il nome e la descrizione di un \glossario{dizionario dati};
  ...
  \item Il dizionario dati può essere utilizzato per la generazione di \glossario{prompt}.
\end{enumerate}

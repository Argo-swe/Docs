...
Nel caso cui il sistema riscontri delle anomalie nella validazione del nome di un \glossario{dizionario dati}, l'Utente visualizza un messaggio d'errore.
...
\paragraph*{Precondizioni}
\begin{itemize}
  \item Il formato del nome del \glossario{dizionario dati} è invalido.
\end{itemize}
...
\begin{enumerate}
  ...
  \item Il sistema riscontra un errore nel salvataggio del \glossario{dizionario dati};
  \item Il sistema restituisce un messaggio con i dettagli dell'errore.  
\end{enumerate}

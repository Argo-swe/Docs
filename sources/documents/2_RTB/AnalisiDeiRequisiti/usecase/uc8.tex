...
\begin{enumerate}
  ...
  \item Negli appunti di sistema viene salvata una copia del \glossario{prompt}, che può essere fornita in input a un LLM esterno per la generazione di una \glossario{query} SQL.
\end{enumerate}
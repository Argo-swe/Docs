...
\begin{itemize}
  ...
  \item Il sistema ha generato almeno un \glossario{prompt} e il rispettivo \glossario{debug}.
\end{itemize}
...
\begin{enumerate}
  ...
  \item Il Tecnico visualizza l'ultimo messaggio di \glossario{log} generato;

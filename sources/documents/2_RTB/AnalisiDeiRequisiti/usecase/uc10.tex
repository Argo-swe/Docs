...
\paragraph*{Postcondizioni}
\begin{itemize}
  \item Viene visualizzata l'estensione del \glossario{dizionario dati}.
\end{itemize}
...
\paragraph*{Postcondizioni}
\begin{itemize}
  \item Viene visualizzata la descrizione del \glossario{dizionario dati}.
\end{itemize}
...
\paragraph*{Postcondizioni}
\begin{itemize}
  \item Viene visualizzata la dimensione del \glossario{dizionario dati}.
\end{itemize}
...
\paragraph*{Postcondizioni}
\begin{itemize}
  \item Viene visualizzata la data di ultimo aggiornamento del \glossario{dizionario dati}.
\end{itemize}

...
\begin{enumerate}
  ...
  \item Se l'Utente che ha effettuato la richiesta è un Tecnico, il sistema genera automaticamente un file di \glossario{log} che documenta il processo di generazione del \glossario{prompt};

...
\begin{enumerate}
  \item Dopo che l’Utente ha inserito una frase in linguaggio naturale e richiesto la generazione del \glossario{prompt} il sistema attua il meccanismo per identificare la parte di \glossario{dizionario dati} adeguata da restituire;

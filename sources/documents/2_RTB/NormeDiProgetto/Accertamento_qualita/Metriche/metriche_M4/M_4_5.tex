\subsubsubsection{Vocaboli inseriti nel vocabolario}
\begin{itemize}
    \item \textbf{Notazione specifica}: M.4.4;
    \item \textbf{Nome}: Vocaboli inseriti nel vocabolario;
    ...
    \[
        \text{Parole inserite nel vocabolario (\%)} =\frac{P_{a}}{P_{t}} \times 100 
    \]
    dove:
    \begin{itemize}

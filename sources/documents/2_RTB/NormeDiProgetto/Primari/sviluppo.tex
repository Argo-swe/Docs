...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item ogni frame è dotato di un'etichetta che ne riporta il nome. Il nome è ChatSQL se si sta interagendo con la radice dell'applicazione, altrimenti viene indicato un caso d'uso se se ne stanno descrivendo i sottocasi.
  \end{itemize}

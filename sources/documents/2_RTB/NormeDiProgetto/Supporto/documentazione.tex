...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \textbf{Cliente e Committente:} scritti con la lettera iniziale maiuscola quando si desidera mantenere un rapporto formale con un attore esterno. Ad esempio, la frase "il ruolo di cliente è rivestito dall'azienda Zucchetti S.p.A." non richiede la lettera maiuscola.
  \end{itemize}

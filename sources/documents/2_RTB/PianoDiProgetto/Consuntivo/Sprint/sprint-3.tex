...
\begin{itemize}
  \item \textbf{Rischi relativi alla collaborazione:} Durante il terzo sprint, l'entusiasmo iniziale è diminuito, rendendo necessario per il gruppo discutere e modificare le regole interne al fine di garantire una collaborazione proficua e continua tra i membri. Il responsabile ha mantenuto correttamente l'ordine seguendo le regole stabilite nelle \NdP; 
  \item \textbf{Malfunzionamenti hardware:} L'integrazione con \glossario{Docker} e lo studio delle diverse tecnologie ha comportanto più volte problematiche software ai membri del gruppo che sono state arginate tempestivamente;
  \item \textbf{Rischi relativi alla rotazione dei ruoli:} Nei primi sprint, i ruoli sono stati mantenuti per l'intera durata dello sprint dai membri del gruppo, i quali hanno avuto l'opportunità di approfondire verticalmente la conoscenza delle loro mansioni, ma non di acquisire una conoscenza orizzontale di tutti i ruoli. Questo ha generato confusione durante il passaggio da uno \glossario{sprint} all'altro.Le riunioni frequenti e il sostegno reciproco durante lo scambio di ruolo sono stati fondamentali per ovviare a questa problematica.
\end{itemize}

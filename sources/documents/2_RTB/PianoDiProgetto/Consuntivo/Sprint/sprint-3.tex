...
\begin{itemize}
  \item Nonostante quanto emerso dal consuntivo orario, dove l'assegnazione temporale per ruolo è risultata sbilanciata a favore dei ruoli più tecnici (analista, progettista, programmatore) rispetto a quelli amministrativi (amministratore, responsabile), il team ha ritenuto opportuno non reindirizzare ulteriori risorse verso questi ultimi a causa delle imminenti necessità di sviluppo a lato codice;
  \item In seguito alle considerazioni del team riguardo la necessità di una maggiore supervisione dei singoli componenti da parte del responsabile in carica, quest'ultimo dovrà impegnarsi, a partire dalla prossima iterazione, a stabilire dei brevi intervallo di tempo oltre i quali verificare che il lavoro di ciascun membro stia procedendo per come previsto;
  \item Attraverso un confronto diretto è emersa un'incomprensione da parte del team nei confronti della Proponente, che risulta essere a tutti gli effetti un committente da cui non aspettarsi conoscenze tecniche: l'uso di terminologia specialistica e opinioni a livello implementativo non devono spettare al cliente ma al gruppo di sviluppo in quanto Fornitore. In futuro sarà quindi necessario mantenere la discussione a più alto livello, concentrandosi sul "cosa" piuttosto che sul "come";

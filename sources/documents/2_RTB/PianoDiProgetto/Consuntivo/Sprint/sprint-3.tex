...
\par Il team ha gestito corettamente durante il terzo sprint i seguenti rischi previsti:
\begin{itemize}
  \item \textbf{Rischi relativi alla collaborazione:} Durante il terzo sprint, calato l'entusiasmo iniziale, il gruppo ha dovuto iniziare a discutere e modificare le regole interne per gestire la collaborazione profiqua e continua tra i membri del gruppo.Il responsabile ha mantenuto correttamente l'ordine seguendo le regole stilate nelle \NdP; 
  \item \textbf{Rischi relativi alla rotazione dei ruoli:} I ruoli nei primi sprint sono stati mantenuti per l'intera durata dello sprint dai membri del gruppo che non hanno avuto la possibilità di verticalizzare la conoscenza delle loro mansioni ma non si è riuscito ad avere prima una conoscenza roizzonatale di tutti i ruoli. Questo ha creato della consusione nel cambio da uno \glossario{sprint} all' altro. 
\end{itemize}

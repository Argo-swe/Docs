...
\par Durante il primo \glossario{sprint}, il team non ha rilevato l'affioramento di rischi inattesi. Tuttavia, alcune contromisure non si sono rivelate sufficienti per mitigare i rischi individuati in fase di pianificazione, perciò il gruppo ha deciso di aggiornare la sezione di analisi dei rischi. In particolare, il gruppo ha riesaminato i seguenti rischi:
\begin{itemize}

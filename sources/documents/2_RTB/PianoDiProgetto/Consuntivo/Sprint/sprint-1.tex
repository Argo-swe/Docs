...
\par Durante il primo \glossario{sprint}, il team non dovuto gestire rischi inattesi. Tuttavia, alcune contromisure si sono rivelate insufficienti per mitigare i rischi individuati in fase di pianificazione; perciò il gruppo ha deciso di aggiornare la sezione di analisi dei rischi. In particolare, sono stati riesaminati i seguenti rischi:
\begin{itemize}

...
\begin{itemize}
  ...
  \item Considerando la pianificazione non dettagliata, l'inesperienza nell'\AdR\ e la distribuzione non omogenea delle ore, il gruppo si è ritrovato a performare al di sotto delle aspettative in determinati ruoli. Tuttavia, questa divisione così netta ha contruibuito alla creazione di micro-gruppi autonomi. Ciò ha favorito la condivisione delle conoscenze e il lavoro in sincronia, riducendo al minimo le perdite dal punto di vista dell'intensità di lavoro, che altrimenti sarebbero risultate pregiudizievoli;
...
\paragraph*{Pianificazione futura:}TODO

\paragraph*{Preventivo "a finire":}TODO

\paragraph*{Gestione dei rischi:}TODO

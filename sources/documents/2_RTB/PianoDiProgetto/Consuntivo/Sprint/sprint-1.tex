...
\vspace{0.5\baselineskip}
\par Durante il primo \glossario{sprint}, alcune contromisure si sono rivelate utili a mitigare i rischi. In particolare:
\begin{itemize}
  \item \textbf{Collaborazione}: Il team ha incontrato degli ostacoli nel lavoro di gruppo, a causa delle differenze in termini di tempistiche, competenze e modalità di interazione. Per arginare la problematica, il gruppo ha organizzato delle riunioni di durata più ampia, durante le quali ciascun componente ha condiviso la sua visione ed esperienza.
\end{itemize}

...
\begin{itemize}
  ...
  \item La modifica di durata degli sprint a circa 1 settimana, è risultato essere abbastanza complesso nella gestione personale, soprattutto durante la sessione di esame, per cui si è deciso di procedere a seguito della \glossario{RTB}, con la ripianificazione degli sprint di lunghezza di 2 settimane in modo da permettere una più semplice organizzazione degli impegni, non inficiando però l'organizzazione del lavoro collaborativo.
\end{itemize}

...
\begin{itemize}
  ...
  \item Le precedenti tecnologie individuate per la parte di \glossario{backend} sono risultate troppo complesse per lo sviluppo in essere, quindi è stata decisa un'ulteriore modifica della libreria, col passaggio a FastAPI;

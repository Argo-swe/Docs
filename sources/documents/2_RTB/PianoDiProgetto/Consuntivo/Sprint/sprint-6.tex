...
\begin{itemize}
  \item \textbf{Rischi relativi a rallentamenti:} In prossimità della sessione di esami, i membri del team hanno crescenti impossibilità nel dedicarsi al progetto in favore di ulteriore studio: di conseguenza, le ore di lavoro di ogni membro sono state ridotte. Essendo un rischio previsto, la data di consegna non verrà alterata poiché era stata pianificata in modo adeguato.
\end{itemize}
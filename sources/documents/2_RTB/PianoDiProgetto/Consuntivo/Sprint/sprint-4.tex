...
\begin{itemize}
  \item \textbf{Rischi relativi a esigenze personali}: Nel corso dello \glossario{sprint}, un membro del team ha incontrato difficoltà nello svolgimento delle proprie mansioni per motivi personali. La gestione anticipata di questa situazione (mediante comunicazione preventiva) ha consentito al gruppo di ricalibrare e ridistribuire le attività precedentemente assegnate, garantendo che il flusso di lavoro rimanesse stabile.
\end{itemize}

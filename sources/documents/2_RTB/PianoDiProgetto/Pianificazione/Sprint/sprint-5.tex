...
Durante lo \glossario{sprint} precedente sono state approfondite ulteriormente le tecnologie di \glossario{Flask} e \glossario{Vue.js} che durante questo sprint saranno usati in sinergia per integrare \glossario{front-end} e \glossario{back-end}.

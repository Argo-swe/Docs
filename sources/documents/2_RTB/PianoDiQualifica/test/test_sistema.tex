...
\begin{adjustwidth}{-0.5cm}{-0.5cm}
	% MAX 12.5cm
 	\begin{longtable}{|P{1.5cm}|>{\raggedright}P{9.5cm}|>{\arraybackslash}P{1.5cm}|}
	  ...
	  \hline
		...
		\hline TS.17 & Verificare che l'Utente possa visualizzare il contenuto del \glossario{dizionario dati} attivo nel sistema. Il sistema deve mostrare le seguenti informazioni:
		\begin{itemize}
		...
		\hline TS.25 & Verificare che il Tecnico possa visualizzare il \glossario{log} relativo all'ultima richiesta inviata. Il log deve contenere le seguenti informazioni:
    \begin{itemize}
    ...
    \end{itemize} & N-D \\ 
		...
		\hline TS.31 & Verificare che il sistema di generazione del \glossario{prompt} supporti richieste in lingue diverse dall'inglese. Le lingue supportate sono: 
		\begin{itemize}
			\item Italiano;
			\item Francese;
			\item Tedesco;

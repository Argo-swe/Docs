	...
	% MAX 12.5cm
 	\begin{longtable}{|P{1.5cm}|>{\raggedright}P{9.5cm}|>{\arraybackslash}P{1.5cm}|}
	  ...
	  \hline
		...
		\hline TS.24 & Verificare che l'Utente possa copiare il contenuto del \glossario{prompt} generato. & N-D \\ 
		...
		\hline TS.27 & Verificare che il Tecnico possa scaricare un file di \glossario{log} contenente il debug del \prompt. & N-D \\

...
\begin{adjustwidth}{-0.5cm}{-0.5cm}
  ...
  \begin{longtable}{|P{4.5cm}|>{\raggedright\arraybackslash}P{9cm}|}
    ...
    \hline Menzione di un soggetto & Quando si menziona una persona, la formula da utilizzare è la seguente: "Nome Cognome". \\
    \hline Ordine alfabetico & Nelle tabelle e negli elenchi, i nomi delle persone devono essere disposti in ordine alfabetico, salvo indicazioni esplicite differenti. \\
  \end{longtable}
\end{adjustwidth}
\egroup

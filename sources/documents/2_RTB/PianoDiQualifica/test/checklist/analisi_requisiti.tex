...
\begin{adjustwidth}{-0.5cm}{-0.5cm}
  ...
  \begin{longtable}{|P{4.5cm}|>{\raggedright\arraybackslash}P{9cm}|}
    ...
    \hline Ordinamento requisiti & I requisiti devono essere ordinati secondo la stessa disposizione dei casi d'uso. \\
		\hline Diagrammi dei casi d'uso & Le inclusioni, estensioni e relazioni di generalizzazione dovrebbero essere rappresentate in un unico diagramma \glossario{UML}. Tuttavia, per motivi di spazio, possono essere riportate anche in diagrammi separati.\\

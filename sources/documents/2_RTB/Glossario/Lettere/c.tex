...
\vspace{2em}
\subsection*{CRUD}
Acronimo che fa riferimento alle 4 operazioni base relative alla gestionre della persistenza dei dati. Le operazioni sono Create (creazione), Read (lettura), Update (aggiornamento), Delete (cancellazione).

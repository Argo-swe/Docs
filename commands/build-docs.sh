...
if [ "$1" = "--help" ] ; then
  echo "
    ...
    DESCRIPTION
    This script allows you (and Travis) to build all internal and/or external documentation of the project. This script makes use of 'build-latex.sh' script and of 'common.config' file.

...
if [ "$1" = "--help" ] ; then
  echo "
    ...
    EXAMPLES
    build-latex.sh LaTex/documents/Glossario Glossario.tex _travis-build -> PDF: ./_travis-build/Glossario.pdf
    build-latex.sh LaTex/documents/Glossario Glossario.tex _travis-build \"G O\" -> PDF: ./_travis-build/G O.pdf"
  exit 0
fi

...
if [ "$1" = "--help" ] ; then
  echo "
    ...
    DESCRIPTION
    This script allows you (and Travis) to zip the compiled LaTeX documents of the project. Before using this script, execute script 'build-latex.sh'.
